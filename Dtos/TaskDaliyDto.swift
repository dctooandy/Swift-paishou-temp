...
//  PS_Catalina
//
//  Created by 張宏宇 on 2020/10/28.
//  Copyright © 2020 Andy Chen. All rights reserved.
//

import Foundation
class TaskDaliyDto: Codable{
    let list: [TaskDaliyListDto]?
    init(list: [TaskDaliyListDto] = [TaskDaliyListDto()]) {
        self.list = list
    }
}
class TaskDaliyListDto: Codable{
...
class DaliyTaskCompletedDto: Codable{
    let is_received: Int?
